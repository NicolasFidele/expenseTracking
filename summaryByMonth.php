<!-- This page is called from modal when the user clicks on navbar dropdown menu Summary -> By Month -->
<?php
//Connect to Database
...
?>
<!-- View Expenses/Income for a particular Month -->
<div class="container-fluid">
	<div class="row justify-content-center mt-3">
		<div class="col-12 col-lg-8 col-xl-6 my-1"> 
			<?php
				//store chosen month and actual year into a variable
				$month = $_SESSION['month'];
				$year = date("Y");
			?>
			<!-- View Expenses for that month -->
			<h5 class="text-center">
				Expenses Summary for <?php echo $month.'/'.$year ?> 
			</h5>
			<table class="table table-sm text-center table-bordered">
				...
				<?php 
					...
					if(isset($_GET['delid'])){
						...
						if($query){ //delete transaction from transactions table also
							$query2 = mysqli_query($conn,"delete from transactions 
							where transaction_id='$id' AND user_id='$userid'");
				...
				<?php
					//display summary by month for expenses
					$userid = $_SESSION['userid'];
					$month = $_SESSION['month']; //fetch chosen month
					$type = 'expenses';
				...
				?>
						<tbody>
							...
							<tr>
								...
								<td><a href="summaryByMonth.php?delid=<?php echo $row['id'];?>"
			...
			<div class="text-muted text-center mt-3">
				<?php  
					...
					WHERE user_id='$userid' AND transaction_type='$type' 
					AND MONTH(transaction_date) = '$month' AND YEAR(transaction_date) = '$year'");
		...
		<div class="col-8 col-lg-6 col-xl-4 my-1">
			<div class="doughnutChart mb-5 justify-content-center">	
				<canvas id="monthChartCanvas" style="height: 75px; width:75px"></canvas>
			</div> 
		</div>
	</div>
	<!--  Display Income for the chosen Month - Same concept as for Expenses-->
	<div class="row justify-content-center mt-3">
		<div class="col-12 col-lg-8 col-xl-6 my-1"> 
			<h5 class="text-center">
				Income Summary for <?php echo $month.'/'.$year ?> 
			</h5>
			<table class="table table-sm text-center table-bordered">
				<thead class="bg-primary">
					<tr>
		...
		<div class="col-8 col-lg-6 col-xl-4"> 	
			<div class="doughnutChart mb-5 justify-content-center">	
				<canvas id="monthChartCanvas2" style="height: 75px; width:75px"></canvas>
			</div> 
		</div>
	</div>
</div>
